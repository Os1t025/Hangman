...
<body>
    ...
    <div class="container">
        <?php
        session_start();
        include 'mediumConfiguration.php';
        include '../methods.php';
        ...
        if (isset($_POST['newWord'])) {
            ...
            // Get the input, update the hidden word (ie handle guesses), and check if the game is over
            ...
            // Add the user input to the used letters array if it is unique to display used letters
        ...
        <form name="inputForm" action="mediumGame.php" method="post"><br>
